...
```
    ...
    ## gcc  -I"C:/PROGRA~1/R/R-45~1.1/include" -DNDEBUG   -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/Rcpp/include/"  -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppEigen/include/"  -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppEigen/include/unsupported"  -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/BH/include" -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/StanHeaders/include/src/"  -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/StanHeaders/include/"  -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppParallel/include/" -DRCPP_PARALLEL_USE_TBB=1 -I"C:/Users/jonat/AppData/Local/R/win-library/4.5/rstan/include" -DEIGEN_NO_DEBUG  -DBOOST_DISABLE_ASSERTS  -DBOOST_PENDING_INTEGER_LOG2_HPP  -DSTAN_THREADS  -DUSE_STANC3 -DSTRICT_R_HEADERS  -DBOOST_PHOENIX_NO_VARIADIC_EXPRESSION  -D_HAS_AUTO_PTR_ETC=0  -include "C:/Users/jonat/AppData/Local/R/win-library/4.5/StanHeaders/include/stan/math/prim/fun/Eigen.hpp"  -std=c++1y    -I"c:/rtools45/x86_64-w64-mingw32.static.posix/include"      -O2 -Wall -std=gnu2x  -mfpmath=sse -msse2 -mstackrealign   -c foo.c -o foo.o
    ## cc1.exe: warning: command-line option '-std=c++14' is valid for C++/ObjC++ but not for C
    ## In file included from C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppEigen/include/Eigen/Core:19,
    ##                  from C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppEigen/include/Eigen/Dense:1,
    ##                  from C:/Users/jonat/AppData/Local/R/win-library/4.5/StanHeaders/include/stan/math/prim/fun/Eigen.hpp:22,
    ##                  from <command-line>:
    ## C:/Users/jonat/AppData/Local/R/win-library/4.5/RcppEigen/include/Eigen/src/Core/util/Macros.h:679:10: fatal error: cmath: No such file or directory
    ##   679 | #include <cmath>
    ##       |          ^~~~~~~
...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.19     0.31 1.00      947     1378
    ## gamma_Intercept      0.33      0.03     0.27     0.38 1.00     1063     1620
    ## lambda_Intercept     1.24      0.30     0.77     1.94 1.00     1202     1582
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1717     1661
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.15     0.27 1.00     1186     1540
    ## gamma_Intercept      0.36      0.03     0.31     0.42 1.00     1310     1409
    ## lambda_Intercept     1.04      0.19     0.73     1.48 1.00     1573     2077
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     2197     2010
    ## phi_Intercept       -0.84      0.11    -1.06    -0.63 1.00     2196     1684
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2380     2017
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
